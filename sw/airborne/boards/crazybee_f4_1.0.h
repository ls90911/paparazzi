...
#define EXT_CLK 12000000                         // 8,12,16,27??Mhz  (TODO: Find out if 16Mhz works)
...
/* TODO Turn SBUS invert on UARTx (C0) */
...
/* SPI2 for OSD */
//#define SPI2_GPIO_AF GPIO_AF5 //TODO check
...
/* SPI3 for RX direct, if implemented in AP */
...
/** Onboard ADCs **/
#define USE_AD_TIM3 1 //TODO check datasheet
...
#if USE_ADC_2
#define AD1_2_CHANNEL 12//TODO check datasheet
#define ADC_2 AD1_2
#define ADC_2_GPIO_PORT GPIOB//TODO check datasheet
#define ADC_2_GPIO_PIN GPIO0//TODO check datasheet

#define ADC_CHANNEL_VSUPPLY ADC_2
#define DefaultVoltageOfAdc(adc) (0.01164*adc) // TODO: Calibrate
#endif

/* Current */
#ifndef USE_ADC_1
#define USE_ADC_1 0 //Disable while developing now
#endif

#if USE_ADC_1
#define AD1_1_CHANNEL 11//TODO check datasheet
#define ADC_1 AD1_1
#define ADC_1_GPIO_PORT GPIOB//TODO check datasheet
#define ADC_1_GPIO_PIN GPIO1//TODO check datasheet
...
#define PWM_SERVO_1_OC TIM_OC3//TODO
#define PWM_SERVO_1_OC_BIT (1<<3)//TODO
#else
...
#define PWM_SERVO_2_OC TIM_OC1//TODO
#define PWM_SERVO_2_OC_BIT (1<<2)//TODO
#else
...
#define PWM_SERVO_3_OC TIM_OC2//TODO
#define PWM_SERVO_3_OC_BIT (1<<1)//TODO
#else
...
#define PWM_SERVO_4_OC TIM_OC3//TODO
#define PWM_SERVO_4_OC_BIT (1<<0)//TODO
#else
#define PWM_SERVO_4_OC_BIT 0
#endif

#define PWM_TIM2_CHAN_MASK (PWM_SERVO_1_OC_BIT)//TODO
#define PWM_TIM4_CHAN_MASK (PWM_SERVO_2_OC_BIT|PWM_SERVO_3_OC_BIT|PWM_SERVO_4_OC_BIT)//TODO
